...
separately on the Player Faction tab. Colonisation tracking/candidates
moved to their own Colonisation tab.
"""
...
from PyQt6.QtWidgets import (
    QWidget, QVBoxLayout, QLabel, QTableWidget, QTableWidgetItem, QHeaderView, QFrame,
)

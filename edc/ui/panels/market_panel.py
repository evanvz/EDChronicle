...
from PyQt6.QtCore import Qt, QObject, QThread, QStringListModel, QTimer, QPoint, QPointF, pyqtSignal
...
class _BusySpinner(QWidget):
    ...
    Repositions on start(); doesn't track the parent resizing mid-spin (a
    live search is brief enough that this is a non-issue in practice).
    """
    _N_DOTS = 12
    _SIZE = 72
    _MIN_DOT_R = 1.0

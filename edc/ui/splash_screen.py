...
BOOT_LINES = [
    ...
    ("LOADING PLANET VALUE DATABASE", "#E6E6E6", 900),
    ("LOADING EXOBIOLOGY CATALOG", "#E6E6E6", 950),
    ("LOADING POWERPLAY ACTIVITIES", "#E6E6E6", 900),
    ("LOADING COMBAT RECORDS", "#E6E6E6", 850),
    ("STARTING TTS ENGINE", "#E6E6E6", 950),
    ("CALIBRATING VOICE SYSTEMS", "#E6E6E6", 900),
    ("ESTABLISHING SENSOR ARRAY", "#E6E6E6", 950),
    ("SCANNING FOR HOSTILES", "#FF8C00", 1100),
    ("CONNECTING TO JOURNAL FEED", "#FF8C00", 1000),
    ("RUNNING SYSTEM DIAGNOSTICS", "#E6E6E6", 950),
    ("ALL SYSTEMS NOMINAL", "#7CFC98", 1100),
    ("LAUNCHING EDCHRONICLE", "#FF8C00", 800),
]

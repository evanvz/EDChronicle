...
Dict keys are the real internal material names, cross-checked against
EDCD/FDevIDs' material.csv and live journal data — entryData.json's own
"FormattedName" field turned out to be unreliable for ~22 Encoded/Data
materials whose display name has a rarity-flavor adjective the real
internal name omits (e.g. "Aberrant Shield Pattern Analysis" displays
that way but the game's actual symbol is just "shieldpatternanalysis"),
so it's used only as a fallback for the handful of newer materials
FDevIDs doesn't have yet.
...
_MATERIAL_INFO: Dict[str, Tuple[int, str, str]] = {
    'shieldpatternanalysis': (4, 'ShieldData', 'encoded'),
    'adaptiveencryptors': (5, 'EncryptionFiles', 'encoded'),
    ...
    'bulkscandata': (1, 'DataArchives', 'encoded'),
    'fsdtelemetry': (2, 'WakeScans', 'encoded'),
    'antimony': (4, 'Category7', 'raw'),
    'archivedemissiondata': (2, 'EmissionData', 'encoded'),
    'arsenic': (2, 'Category6', 'raw'),
    'disruptedwakeechoes': (1, 'WakeScans', 'encoded'),
    'encryptionarchives': (4, 'EncryptionFiles', 'encoded'),
    ...
    'industrialfirmware': (3, 'EncodedFirmware', 'encoded'),
    'crystalshards': (1, 'Crystals', 'manufactured'),
    'dataminedwake': (5, 'WakeScans', 'encoded'),
    'decodedemissiondata': (4, 'EmissionData', 'encoded'),
    'shieldcyclerecordings': (1, 'ShieldData', 'encoded'),
    'hyperspacetrajectories': (4, 'WakeScans', 'encoded'),
    'electrochemicalarrays': (3, 'Capacitors', 'manufactured'),
    'emissiondata': (3, 'EmissionData', 'encoded'),
    'encodedscandata': (4, 'DataArchives', 'encoded'),
    'scrambledemissiondata': (1, 'EmissionData', 'encoded'),
    ...
    'shieldsoakanalysis': (2, 'ShieldData', 'encoded'),
    ...
    'consumerfirmware': (2, 'EncodedFirmware', 'encoded'),
    'embeddedfirmware': (5, 'EncodedFirmware', 'encoded'),
    'molybdenum': (3, 'Category2', 'raw'),
    'nickel': (1, 'Category5', 'raw'),
    'niobium': (3, 'Category1', 'raw'),
    'symmetrickeys': (3, 'EncryptionFiles', 'encoded'),
    'shieldfrequencydata': (5, 'ShieldData', 'encoded'),
    ...
    'securityfirmware': (4, 'EncodedFirmware', 'encoded'),
    ...
    'legacyfirmware': (1, 'EncodedFirmware', 'encoded'),
    'wakesolutions': (3, 'WakeScans', 'encoded'),
    'sulphur': (1, 'Category3', 'raw'),
    'encryptioncodes': (2, 'EncryptionFiles', 'encoded'),
    ...
    'scanarchives': (2, 'DataArchives', 'encoded'),
    ...
    'encryptedfiles': (1, 'EncryptionFiles', 'encoded'),
